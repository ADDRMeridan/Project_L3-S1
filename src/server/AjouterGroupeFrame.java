 ...
 */
public class AjouterGroupeFrame extends javax.swing.JFrame {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		int idGroupe = 0;
		Boolean idOK = true;
		IGestionBDD serv = new GestionBDD();
		try {
		...
		if (idOK) {
			if (serv.ajouterGroupe(idGroupe, jTextField3.getText())) {
				this.setVisible(false);
				new JFrameServeur().setVisible(true);
			}
			jTextField1.setText("Id Groupe déjà utiliser");
		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(AjouterUtilisateurFrame.class.getName())
